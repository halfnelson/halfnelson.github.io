...
<p>The <em>Gamma function</em> satisfying <script type="math/tex" id="MathJax-Element-19">\Gamma(n) = (n-1)!\quad\forall n\in\mathbb N</script> is via the Euler integral</p>
